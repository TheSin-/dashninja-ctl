...
EOT;
    ...
    unlink(TMN_DBGEN_SEMAPHORE);
}



xecho("\033[1;31mTRC Ninja \033[0;31mControl \033[1;33mDatabase Generator \033[0;37mv\033[1;32m".TMN_VERSION."\n");
...
$mysqli = new mysqli(TMNCTLMYSQLHOST, TMNCTLMYSQLUSER, TMNCTLMYSQLPASS, TMNCTLMYSQLDATABASE);
